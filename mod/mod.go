...
// Addition modulo n: a mod n = r such that a = kn + r for some
// integer k and r in [0,n).
...
// a+b = kn+r. If n > 0, then 0 <= r < n. Otherwise, n < r <= 0. Panics if n = 0.
...
// Mod returns r such that a = kn + r for some integer k. If n > 0, then
// 0 <= r < n. Otherwise, n < r <= 0. Note this is NOT equivalent to a % n.
